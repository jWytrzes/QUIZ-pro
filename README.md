...
Aplikacja frontendowa nie zawiera formularza do tworzenia nowych quizów, ale można to zrobić korzystając z dokumentacji API znajdującej się pod adresem:
`baseUrl/doc`
